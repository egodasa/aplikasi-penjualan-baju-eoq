...
<html>
	...
	<body>
		...
		<table>
			...
			<?php
				$no = 1;
				$sql_query = mysqli_query($koneksi, "SELECT eoq.*, barang.kode_barang, barang.nama_barang, barang.stock FROM eoq JOIN barang ON eoq.kode_barang = barang.kode_barang");
