...
<html>
	...
	<body>
		...
		<div style="text-align: center;"><h3>Laporan Penjualan Harian <br> <?=tanggal_indo($tanggal)?></h3></div>
		<hr>
		<table>
			<tr>
				<th>No</th>
...
From
    ...
    penjualan On detail_penjualan.no_nota = penjualan.no_nota WHERE penjualan.tgl_jual = '$tanggal' ORDER BY penjualan.tgl_jual ASC");
